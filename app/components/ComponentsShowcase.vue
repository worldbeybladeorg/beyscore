  ...
  <div class="min-h-screen flex items-center justify-center py-24 px-24">
    <div class="flex flex-col items-center justify-center gap-6">
      ...
      <div class="flex flex-col items-center justify-center gap-4">
        <h2 class="font-titillium text-base font-semibold text-slate-500">Landscape Navigation</h2>
        <LandscapeNavigation 
      ...
      <div class="flex flex-col items-center justify-center gap-6">
        ...
        <div class="flex flex-col items-center gap-4">
          <h2 class="font-titillium text-xl font-bold text-slate-600">X Format</h2>
          <div class="flex flex-row items-center justify-center gap-4">
        ...
        <!-- Burst Format -->
        <div class="flex flex-col items-center gap-4">
          <h2 class="font-titillium text-xl font-bold text-slate-600">Burst Format</h2>
          <div class="flex flex-row items-center justify-center gap-4">
        ...
        <!-- MFB/Zero-G Format -->
        <div class="flex flex-col items-center gap-4">
          <h2 class="font-titillium text-xl font-bold text-slate-600">MFB/Zero-G Format</h2>
          <div class="flex flex-row items-center justify-center gap-4">
        ...
        <!-- Plastics/HMS Format -->
        <div class="flex flex-col items-center gap-4">
          <h2 class="font-titillium text-xl font-bold text-slate-600">Plastics/HMS Format</h2>
          <div class="flex flex-row items-center justify-center gap-4">
      ...
      <!-- GameSummary preview -->
      <div class="flex flex-col items-center justify-center gap-2 w-[320px]">
        <h2 class="font-titillium text-base font-semibold text-slate-500">Game Summary</h2>
        <GameSummary :items="gameSummaryItems" />
      </div>

      <!-- GameResults preview - X Format -->
      <div class="flex flex-col items-center justify-center w-[348px] gap-4">
        <h2 class="font-titillium text-base font-semibold text-slate-500">Game Results – X Format</h2>
        <GameResults winnerName="Player 1" format="x" />
      </div>

       <!-- GameResults preview - X Format with opponent summary edge case -->
      <div class="flex flex-col items-center justify-center w-[348px] gap-4">
        <h2 class="font-titillium text-base font-semibold text-slate-500">Game Results – X Format (Opponent Summary)</h2>
        <GameResults winnerName="Player 1" format="x" :showOpponentSummary="true" />
      </div>

      <!-- GameResults preview - Burst Format -->
      <div class="flex flex-col items-center justify-center w-[348px] gap-4">
        <h2 class="font-titillium text-base font-semibold text-slate-500">Game Results – Burst</h2>
        <GameResults winnerName="Player 1" format="burst" />
      </div>

      <!-- GameResults preview - MFB / Plastics / HMS -->
      <div class="flex flex-col items-center justify-center w-[348px] gap-4">
        <h2 class="font-titillium text-base font-semibold text-slate-500">Game Results – MFB / Plastics / HMS</h2>
