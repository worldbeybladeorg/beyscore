<template>
  <div class="viewport-container-landscape">
    ...
    <button class="orientation-toggle-landscape" @click="toggleOrientation" title="Switch to portrait">
        ...
        <div class="modal-content settings-modal-content" :class="{ 'closing': isSettingsModalClosing }" @click.stop>
          ...
          <div class="settings-buttons-container">
            <div class="settings-buttons">
              ...
              <Button variant="secondary" class="reset-game-button-transparent" @click="handleResetGame">Reset Game</Button>
            </div>
          </div>
        </div>
      </div>
...
.orientation-toggle-landscape:hover {
  opacity: 0.9;
}

.game-screen-landscape {
  /* PWA viewport in landscape - matches actual device dimensions when installed */
  /* Width (horizontal): 640px (Android baseline) to 926px (iPhone Pro Max, large Android) */
  ...
  max-width: 926px; /* iPhone Pro Max, large Android phones */
